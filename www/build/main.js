...
// import { NavController,AlertController, LoadingController, Select, ActionSheetController } from 'ionic-angular';
...
//       '<br><br><p align="center"><button onclick="listspot()" style="background:#000;background-color: white; padding: 10px;color: black;border: 2px solid #ae6c2f; margin-right:20px;" >List as '+this.pinspotas+'</button></p>'+
//       '<br>><br>'+
//       '</div>'+
//       '</div>';
//       map.setZoom(15);
...
//       // infowind.addListener('closeclick', (e) => {
//       // });
//       marker.addListener('click', function() {
//         if(map.getZoom() != 13 && map.getZoom() != 15){
//           map.setZoom(15);
...
//         }
//       });
//       // this.pinspotandpostdetails(position, this.pinspotas);
//       return marker;
//   }
//   listspot(){
...
//     });
//   }
//   pinspotandpostdetails(position, pintype){
